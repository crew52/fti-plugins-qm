...
public class EquipmentQualityStandardLFields {
    private EquipmentQualityStandardLFields() {
    ...
    public static final String EQUIPMENT_QUALITY_STANDARD_H = "equipmentQualityStandardH";
}
