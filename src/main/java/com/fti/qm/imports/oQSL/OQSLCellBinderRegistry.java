...
public class OQSLCellBinderRegistry {
    ...
    @PostConstruct
    private void init() {
        cellBinderRegistry.setCellBinder(required(QSLFields.QUALITY_STANDARD_H, qshOutgoingLookupByProductNumberParser));
