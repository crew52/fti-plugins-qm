...
public class QSHsListListeners {
    ...
    public void openIPQSHsImportPage(final ViewDefinitionState view, final ComponentState state, final String[] args) {
        StringBuilder url = new StringBuilder("../page/qm/iPQSHsImport.html");

        view.openModal(url.toString());
    }

    public void openEQSHsImportPage(final ViewDefinitionState view, final ComponentState state, final String[] args) {
        StringBuilder url = new StringBuilder("../page/qm/eQSHsImport.html");
