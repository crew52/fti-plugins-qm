...
<script src="/qm/public/js/multiuploadforincomingfunctions.js"></script>
...
<form id="fileupload" action="../../../rest/qm/multiUploadForIncomingFiles.html" method="POST" enctype="multipart/form-data">
