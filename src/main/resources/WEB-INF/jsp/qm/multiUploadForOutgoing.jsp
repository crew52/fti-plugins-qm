...
<script src="/qm/public/js/multiuploadforoutgoingfunctions.js"></script>
...
<form id="fileupload" action="../../../rest/qm/multiUploadForOutgoingFiles.html" method="POST" enctype="multipart/form-data">
