...
<script src="/qm/public/js/multiuploadforqualitystandardhfunctions.js"></script>
...
<form id="fileupload" action="../../../rest/qm/multiUploadForQualityStandardHFiles.html" method="POST" enctype="multipart/form-data">
